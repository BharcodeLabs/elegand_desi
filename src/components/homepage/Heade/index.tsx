...
const Header = () => {
  return (
    <header className="bg-gradient-to-r from-[#ffead7] to-[#fff5eb] pt-10 md:pt-24 overflow-hidden">
        ...
        <section className="max-w-frame px-4">
          <motion.h2
            ...
            className={cn([
              ...
              "text-4xl lg:text-[64px] lg:leading-[64px] mb-5 lg:mb-8 text-primary",
            ])}
          >
            CELEBRATE YOUR HERITAGE WITH ELEGAND
          </motion.h2>
          <motion.p
          ...
          >
            Discover exquisite traditional Desi fashion that honors your cultural roots. From stunning sarees to elegant lehengas, each piece is crafted with meticulous attention to detail and timeless elegance.
          </motion.p>
          <motion.div
            initial={{ y: "100px", opacity: 0 }}
            whileInView={{ y: "0", opacity: 1 }}
          ...
          >
            <Link
              href="/shop"
              className="w-full md:w-52 mb-5 md:mb-12 inline-block text-center bg-primary hover:bg-primary/90 transition-all text-white px-14 py-4 rounded-full hover:animate-pulse"
            >
              Explore Collection
            </Link>
          </motion.div>
